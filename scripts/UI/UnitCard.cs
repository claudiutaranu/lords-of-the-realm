...
public static class UnitCard
{
		...
		bool titled, Action pressed = null, int pad = 5)
	{
		...
		// Nothing inside the card takes the mouse: a card you can pick is picked by pressing it
		// anywhere, not only on the sliver of frame around what is drawn on it.
		...
		var picture = new PanelContainer
		{
